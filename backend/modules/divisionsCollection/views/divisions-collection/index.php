        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Create new Divisions Collections','class'=>'btn btn-secondary','data-pjax'=>0]).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="fa fa-list"></i> Divisions Collections listing',
