        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote', 'data-pjax'=>0, 'title'=> 'Create new Contract Document Files','class'=>'btn btn-secondary']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="fa fa-list"></i> Contract Document Files listing',
