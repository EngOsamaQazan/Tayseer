...
<div class="rp-page">
    ...
    <div class="rp-filter-card" x-data="{ open: true }">
        ...
        <div class="rp-filter-body" x-show="open" x-cloak
            ...
            <div style="display: flex; align-items: center; gap: 12px; margin-top: 6px;">
                ...
                <?= Html::a('<i class="fa fa-eraser"></i> مسح', ['/reports/reports/judiciary-index'], ['class' => 'btn btn-secondary', 'style' => 'border-radius: 8px;']) ?>
            </div>
    ...
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="fa fa-refresh"></i>', ['/reports/reports/judiciary-index'], ['data-pjax' => 1, 'class' => 'btn btn-secondary', 'title' => 'تحديث']) .
                    '{toggleData}' .
