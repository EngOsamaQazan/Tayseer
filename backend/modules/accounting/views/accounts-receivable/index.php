...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-arrow-circle-down"></i> <?= $this->title ?> <span class="badge"><?= $stats['count_open'] ?> مفتوحة</span></h3>
        <div class="box-tools">
    ...
    <div class="box-body">
        <?php Pjax::begin(['id' => 'receivables-pjax']); ?>
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        return $model->customer ? $model->customer->first_name . ' ' . ($model->customer->last_name ?? '') : 'غير محدد';
                    },
                ],
                [
                    ...
                    'label' => 'الوصف',
                    'value' => function ($model) {
                        return mb_substr($model->description ?? '', 0, 40) . (mb_strlen($model->description ?? '') > 40 ? '...' : '');
                    },
                ],
                [
                    'attribute' => 'amount',
                ...
                [
                    ...
                    'value' => function ($model) {
                        $btns = '';
                        if ($model->status !== 'paid' && $model->status !== 'written_off') {
