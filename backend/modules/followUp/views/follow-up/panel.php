...
// Register OCP assets
$this->registerCssFile(Yii::$app->request->baseUrl . '/css/ocp.css?v=20260407', ['depends' => [\yii\web\JqueryAsset::class]]);
...
$purchaseDateLabel = $purchaseDateRaw
    ? Yii::$app->formatter->asDate($purchaseDateRaw)
    : '—';
...
<div class="ocp-page <?= $isClosed ? 'ocp-page--settled' : '' ?>">
    ...
    <div class="ocp-status-bar">
        <div class="ocp-status-bar__inner">
            ...
            <?php // تاريخ الشراء (حقول العقد: Date_of_sale) ?>
            <div class="ocp-status-bar__meta" title="تاريخ إبرام عقد البيع / الشراء في النظام">
                ...
                <span class="ocp-status-bar__meta-label">تاريخ الشراء</span>
                <span class="ocp-status-bar__meta-value"><?= Html::encode($purchaseDateLabel) ?></span>
            </div>
