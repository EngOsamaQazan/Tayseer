...
<div class="ocp-page <?= $isClosed ? 'ocp-page--settled' : '' ?>">
    ...
    <div class="ocp-status-bar">
        <div class="ocp-status-bar__inner">
            ...
            <?php // تاريخ الاستحقاق الأول (حقول العقد: first_installment_date) ?>
            <div class="ocp-status-bar__meta" title="تاريخ أول قسط مستحق">
                <i class="fa fa-calendar ocp-status-bar__meta-icon" aria-hidden="true"></i>
                <span class="ocp-status-bar__meta-label">تاريخ الاستحقاق الأول</span>
