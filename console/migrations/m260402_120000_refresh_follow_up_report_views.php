...
/**
 * Re-creates os_follow_up_report and os_follow_up_no_contact views.
 *
 * Needed because namaa's views became stale (missing never_followed,
 * effective_installment, due_installments, due_amount columns).
 * Idempotent — safe to run on any server.
 */
class m260402_120000_refresh_follow_up_report_views extends Migration
{
