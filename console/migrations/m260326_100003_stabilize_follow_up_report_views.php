...
/**
 * Phase 1.3 + 1.4 — تثبيت os_follow_up_report و os_follow_up_no_contact
 *
 * نقل SQL من FollowUpReportController::createFollowUpReportView()
 * و createNoContactView() إلى migration ثابت.
 * بعد تنفيذ هذا الـ migration، يجب حذف الدوال من الكنترولر.
 */
class m260326_100003_stabilize_follow_up_report_views extends Migration
{
...
WHERE c.is_can_not_contact = 1
    ...
    {
        $this->execute("DROP VIEW IF EXISTS os_follow_up_no_contact");
        $this->execute("DROP VIEW IF EXISTS os_follow_up_report");
    }
}
